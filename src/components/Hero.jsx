...
const Hero = () => {
    ...
    return (
        <section className="bg-hero bg-cover ss:bg-center bg-no-repeat w-full ss:h-[500px] h-[350px] relative">
            <div className="w-full absolute z-2 ss:top-32 top-10 pl-2">
                <h1 
                    ...
                    className="font-sans lg:text-[40px] ss:text-[35px] text-[32px]"
                >
                ...
                <p className="ss:max-w-[650px] max-w-[400px] ss:mt-[6px] mt-[3px] ss:text-[20px] text-[15px] 
                ...
                <div className="flex justify-between items-center ss:w-[40%] w-[75%] ss:h-[40px] h-[35px] ss:mt-8 mt-5">
                    <button 
