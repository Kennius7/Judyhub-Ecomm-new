...
const Popular = () => {
    ...
    return (
        <section className="bg-slate-100 md:py-6 ss:py-4 py-2">
            <div className="w-full text-[30px] font-bold text-center py-[10px]">
                Popular Products
            </div>
            <hr className="h-[3px] md:w-1/2 mx-auto bg-gradient-to-l from-transparent via-black to-transparent mb-[80px]"/>
